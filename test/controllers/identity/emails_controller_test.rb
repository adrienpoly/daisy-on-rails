...
class Identity::EmailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update email" do
    patch identity_email_url, params: {email: "new_email@daisy.com", password_challenge: "123456"}
    assert_redirected_to root_url
  end

  test "should not update email with wrong password challenge" do
    patch identity_email_url, params: {email: "new_email@daisy.com", password_challenge: "SecretWrong1*3"}
